<template>
  <div>
    ...
    <div id="page">
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12 text-center logo-wrap">
              <div id="fh5co-logo">
                <a href="index.html">Kitchen 218</a>
              </div>
            </div>
      ...
      <header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(~/assets/images/front_of_building.jpg);" data-stellar-background-ratio="0.5">
        <div class="overlay" />
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="display-t js-fullheight">
                <div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
                  <h1><em>The</em> Nightlife of Pulaski</h1>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6  img-wrap animate-box" data-animate-effect="fadeInLeft">
              <img class="img-thumbnail" src="~/assets/images/family.jpg" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
            </div>
            ...
            <div class="col-md-6 col-md-push-1 animate-box">
              <aside id="fh5co-slider-wrwap">
                <div class="flexslider">
                  <ul class="slides">
                    <li style="background-image: url(~/assets/~/assets/images/gallery_7.jpeg);">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="fh5co-blog animate-box">
                <a href="#" class="blog-bg" style="background-image: url(~/assets/images/gallery_1.jpeg);" />
                <div class="blog-text">
                  <span class="posted_on">Feb. 15th 2016</span>
                  <h3><a href="#">Photoshoot On The Street</a></h3>
                  <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                  <ul class="stuff">
                    <li><i class="icon-heart2" />1.2K</li>
                    <li><i class="icon-eye2" />2K</li>
                    <li><a href="#">Read More<i class="icon-arrow-right22" /></a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="fh5co-blog animate-box">
                <a href="#" class="blog-bg" style="background-image: url(~/~/assets/images/gallery_2.jpeg);" />
                <div class="blog-text">
                  <span class="posted_on">Feb. 15th 2016</span>
            ...
            <div class="col-md-4">
              <div class="fh5co-blog animate-box">
                <a href="#" class="blog-bg" style="background-image: url(~/assets/images/gallery_3.jpeg);" />
                <div class="blog-text">
                  <span class="posted_on">Feb. 15th 2016</span>
          ...
          <div class="row copyright">
            <div class="col-md-12 text-center">
              <p>
                ...
                <small class="block">Designed by <a href="http://freehtml5.co/" target="_blank">FreeHTML5.co</a> Demo ~/assets/images: <a href="http://unsplash.co/" target="_blank">Unsplash</a></small>
              </p>
              <p>
                <ul class="fh5co-social-icons">
                  <li><a href="#"><i class="icon-twitter2" /></a></li>
                  <li><a href="#"><i class="icon-facebook2" /></a></li>
                  <li><a href="#"><i class="icon-linkedin2" /></a></li>
                  <li><a href="#"><i class="icon-dribbble2" /></a></li>
                </ul>
              </p>
            </div>
          </div>
    ...
    <div class="gototop js-top">
      <a href="#" class="js-gotop"><i class="icon-arrow-up22" /></a>
    </div>
  </div>
</template>
